...
spark:-	writeln('Hola , mi nombre es 343 Gulty Spark monitor de la instalacion 04, estaré encantado de asistirle (consultas con . al final)'),
	readln(Input),
	spark(Input),!.
...
% pregunta algo que le gusta a spark
template([te, gustan, las, s(_), _], [flagLike], [3]).
template([te, gustan, los, s(_), _], [flagLike], [3]).

		 % pregunta algo que hace spark
template([tu, eres, s(_), _], [flagDo], [2]).
% pregunta algo que es spark
