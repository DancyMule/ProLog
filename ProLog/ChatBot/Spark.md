# Chatbot botulismo - Halo || Proyecto final
### El programa se iniciará cunado se introduzaca la palabra 'spark' seguido de un punto. Esta palabra fue elegida por el tema elegido 'Halo', siendo el monitor de la instalación 04, una inteligencia artificial de este mundo ficticio.
~~~
% Llamamiento inicial
...
~~~
### El programa siempre estará a la espera de las entradas del usuario.
~~~
	readln(Input),
	spark(Input),!.
~~~
...
### Estos son los templates designados para terminar la ejecición.
~~~
	% despedidas
...
### Cada que hay un input del usuario primero se buscara si algun template declarado coincide, en caso de que lo haga se ejecutará lo que se implique en este template
~~~
	spark(Input) :-
...
### Estos son algunos templates que funcionan como ejemplo para la manipulación de la cadena de texto posicionado en la posción n (esta posicion se indica en los ultimos corchetes).
~~~
	% saludos
...
### Bastante similar a lo anterior, con la diferencia de que la variable 'X' obtendrá el valor en los segundos corchetes. Este valor es una bandera/Flag. Lo cual indica que debe iniciar otro proceso que exclusivo para la bandera en cuestión
~~~
...
### Este template es un pequeño indice para el usuario, puede consultarlo para conocer las capacidades de Spark.
~~~
...
~~~	
# Templates del botulismo
### Estos son los templates de información general a cerca del botulismo. Todos regresan la misma información pero tienen entradas diferentes.
~~~
...
## Templates de sintomas
### Estos templates llamaran a toda la lista de hechos unarios que correspondan a los sintomas
~~~
...
## Templates de causas
### Estos templates llamaran a toda la lista de hechos unarios que correspondan a los causas
~~~
...
### Estos templates llamaran a toda la lista de hechos unarios que correspondan a los especialistas
~~~
...
## Templates de trataemiento
### Estos templates llamaran a toda la lista de hechos unarios que correspondan a los trataemiento
~~~
...
### Mediante oraciones a manera de afirmación, el usuario puede verificar si x palabra corresponde a alguina lista de hechos del botulismo. Cada template tiene una bandera unica para iniciar el proceso de busqueda y comparación.
~~~
	% templates comparativos del botulismo
...
## Facciones
### Estos templates llamaran a toda la lista de hechos unarios que correspondan a las facciones existentes
~~~
	% facciones halo
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente a la UNSC
~~~
		% unsc
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente al Covenant
~~~
		% covenant
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente a los herejes
~~~
		% herejes
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente a los Forerunner
~~~
		% faccion forerunner
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente a los Flood
~~~
		% faccion flood
...
## Especies
### Estos templates llamaran a toda la lista de hechos unarios que correspondan a las especies existentes
~~~
	% especies halo
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente a los humano
~~~
		% humanos
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente a los creados
~~~
		% creado
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente a los sangheili
~~~
		% sangheili
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente a los jiralhanae
~~~
		% jiralhanae
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente a los Kig'Yar
~~~
		% Kig_yar
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente a los unggoy
~~~
		% Unggoy
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente a los san'hyuum
~~~
		% san_shyuum
...
### Estos templates llamaran a toda la lista de hechos unarios que correspondan a los estados existentes
~~~
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente a los vivos/activos
~~~
		% activo
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente a los muertos/inactivos
~~~
		% muerto
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente a los desaparecidos
~~~
		% desaparecidos
...
## Juegos de Halo
### Estos templates llamaran a toda la lista de hechos unarios que correspondan a los juegos existentes
~~~
	% juegos de halo
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente al juego Halo Combat Evolved
~~~
		% haloCE
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente al juego Halo 2
~~~
		% halo 2
...
### Estos templates llamaran a toda la lista de personajes en hechos unarios que correspondan especificamente al juego Halo 3
~~~
		% halo 3
...
### Estos templates llamaran a toda la lista de personajes existentes
~~~
	% personajes de halo
...
## Templates comparativos de Halo 
### Mediante oraciones a manera de afirmación, el usuario puede verificar si x palabra corresponde a alguina lista de hechos de Halo. Cada template tiene una bandera unica para iniciar el proceso de busqueda y comparación.
~~~
...
### Estos son los templates de información general a cerca de Halo. Todos regresan la misma información pero tienen entradas diferentes.
~~~
	% info halo
...
### En caso de no encontrar ningun template adecuado, se entrará a este template como default.
~~~
	% templates default
...
## Hechos del botulismo
	% HECHOS SOBRE MI ENFERMEDAD "BOTULISMO"
	% Hechos y flag de causas del botulismo
### Cuando una bandera es encontrada, llamara a una funcion de busqueda que analizará si la lista de hechos especifica contiene lo dado por el usuario, pudiendo confirmar o negar la existencia de este hecho dentro de la lista, esto está al comienzo de cada lista de hechos.
~~~
...
~~~
### A continuación todos los hechos y funciones de busqueda en listas.
~~~
...
### Esta parte es esencial para confirmar si el input dado por el usuario le corresponde algun template
~~~
	match([],[]).
	match([], _):- true.
...
~~~
## replace0 generales
### Aqui es donde entrará en caso de detectar alguna bandera, la cual llamara a su funcion de busqueda específica.
~~~
	% spark likes:
